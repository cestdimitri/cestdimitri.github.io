...
(function () {
  const EN = {
    'cs.doc.title'  : 'Chistetika Lab — UX case — Dimitrii Andreenko',
    'cs.meta.desc'  : 'Research, structure, copy and wireframes for a landing page in a new product category. UX case by Dimitrii Andreenko.',
    'cs.back'       : 'All work',
    ...
    'cs.zoom.prev'  : 'Previous version',
    'cs.zoom.next'  : 'Next version',
    'cs.zoom.close' : 'Close',
  ...
  const RU = {
    ...
    'cs.k.team'     : 'Команда',
    'cs.v.team'     : 'Креативный директор, визуальный дизайнер, арт-директор клиента, технологи формулы',
    'cs.k.year'     : 'Год',
    ...
    'cs.h.problem'  : 'Сложность',
    'cs.pr.1t'      : 'В категории нет экспертизы.',
    ...
    'cs.pr.2p'      : 'Прямых конкурентов меньше шести, у нескольких почти та же формула, только без бренда. Отстроиться составом было нельзя.',
    ...
    'cs.res.p1'     : 'Шесть прямых конкурентов: тональность, эко-заявления и то, как каждый подаёт категорию. Вместе с технологами я построчно прошёл составы в поисках свойств, которые можно заявить как преимущество, — не придумать, а найти.',
    ...
    'cs.f2.cap'     : 'Шесть прямых конкурентов: тональность, эко-заявления и то, как каждый подаёт категорию',
    ...
    'cs.f4.k1'      : 'Макет',
    'cs.f4.cap'     : 'Прозрачность показана, а не заявлена: у каждого ингредиента написана функция, согласованная с технологами построчно',
    ...
    'cs.str.p3'      : 'Из этого порядка следует и вёрстка: одна мысль на полосу во всю ширину, светлый нейтральный фон, каждая полоса — карточка с большим воздухом вокруг, чтобы читатель мог остановиться в любом месте и понимать, на какой вопрос сейчас отвечают. Сценарии несут фотографии, линейку держит переключатель вкладок без второй страницы, а состав стоит простой таблицей в две колонки — единственное место на странице, где ничто не оформлено, чтобы убеждать.',
    ...
    'cs.dia.b3'     : 'О бренде',
    'cs.dia.q3'     : 'Почему вам можно это доверить?',
    ...
    'cs.lost.p1'    : 'Две вкладки продают то, чего не существует. Я возражал против анонса линейки без подтверждённых сроков; клиент был уверен и настоял. Я ограничил ущерб — только вкладки, подпись «скоро в продаже» и ничего за ними. Если сроки сдвинутся, это страница с двумя лишними вкладками, а не с двумя пустыми дырами.',
    'cs.lost.p2'    : 'Линейку поставили на паузу. Вкладки остались. Ограничение смягчило последствия и всё равно пронесло плохое решение в продакшен — честным решением было выпустить страницу без них.',
    ...
    'cs.f8.v5'      : 'v5 — финал: моя структура, вёрстка и тексты в готовом дизайне и с финальным визуальным контентом',
    'cs.zoom.prev'  : 'Предыдущая версия',
    'cs.zoom.next'  : 'Следующая версия',
    'cs.zoom.close' : 'Закрыть',
    'cs.f9.a'       : 'v5 — финальная версия, согласованная',
